  ...
  return (
    <div className="container about-container d-flex flex-row align-items-center justify-content-between">
      ...
      <div className="text-content d-flex flex-column">
        ...
        <p>
          Beyond just coding, I have a strong appreciation for <span>communication</span>, <span>mentorship</span>, and building meaningful <span>relationships</span>. I am a firm believer in teamwork, fostering a positive work culture,
          and encouraging innovation within any environment.
        </p>
